...
[백엔드에서 소셜 로그인 구현하기 🔐 + 프론트에서 해야 할 일 총정리 (feat. OAuth2.0)](https://bbang.dev/posts/spring/백엔드에서-소셜-로그인-구현하기-프론트에서-해야-할-일-총정리-feat-oauth2-0)
