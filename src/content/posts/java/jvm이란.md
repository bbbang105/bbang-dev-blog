...
이러한 특징 때문에 **자바는 컴파일 언어가 아닌 하이브리드 언어**라 부르는 것이 맞으며, [이에 대해서는 글로 정리](https://bbang.dev/posts/java/자바는-컴파일-언어인가)해두었다.
...
GC에 대해서는 [해당 글](https://bbang.dev/posts/java/gc란)로 정리해두었다.
