---
title: "⛳️ 트랜잭션이란"
date: 2025-05-26
tags: ["database", "backend"]
description: "데이터베이스 트랜잭션의 ACID 특성과 COMMIT, ROLLBACK 등 제어 구문의 내부 동작을 설명합니다."
category: "DB"
---
# ⛳️ DB 트랜잭션이란?
...
단, 모든 경우에서 참조를 막지는 않는다. 이는 **[트랜잭션 격리 수준 (Isolation Level)](https://bbbang105.github.io/DB/Isolation-Level(%EA%B2%A9%EB%A6%AC-%EC%88%98%EC%A4%80)%EC%9D%B4%EB%9E%80)** 에 따라서 달라질 수 있다.
