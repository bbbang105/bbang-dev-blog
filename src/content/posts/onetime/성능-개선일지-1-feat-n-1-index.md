---
title: "🚀 성능 개선일지 1 (feat. N+1, Index)"
category: "OneTime"
date: 2025-05-21
...
이전에 [로깅을 개선](https://bbang.dev/posts/spring/조악한-로깅-개선해-보기)하면서 각 API에 대한 처리 속도를 측정할 수 있게 되었다. 
...
[DB 인덱스에 대해서는 최근에 공부](https://bbang.dev/posts/db/index란 했기 때문에, 지금까지 적용을 해 본 적은 없었다.
